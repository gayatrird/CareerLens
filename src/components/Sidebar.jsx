  ...
  return (
    ...
    <aside className="fixed left-0 top-16 h-[calc(100vh-64px)] w-64 z-40 bg-[#0F1115] border-r border-[#27272A] hidden lg:flex flex-col">
      ...
      <nav className="flex-1 py-2 flex flex-col">
        ...
        <button className={getTabClass('NAVIGATOR')} onClick={() => setActiveTab && setActiveTab('NAVIGATOR')}>
          <span
            className="material-symbols-outlined text-[18px]"
            style={{ fontVariationSettings: activeTab === 'NAVIGATOR' ? "'FILL' 1" : "'FILL' 0" }}
          >explore</span>
          <span className="text-xs font-semibold tracking-wider">Career Navigator</span>
        </button>
        ...
        <button className={getTabClass('APPLICATIONS')} onClick={() => setActiveTab && setActiveTab('APPLICATIONS')}>
          <span
            className="material-symbols-outlined text-[18px]"
            style={{ fontVariationSettings: activeTab === 'APPLICATIONS' ? "'FILL' 1" : "'FILL' 0" }}
          >business_center</span>
          <span className="text-xs font-semibold tracking-wider">Applications</span>
        </button>
